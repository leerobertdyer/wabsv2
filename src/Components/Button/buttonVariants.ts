...
export const button = tv({
	base: 'py-2 px-4 mt-2 mb-2 rounded-[2.25rem] h-[3.125rem] flex justify-center items-center border-none font-bold cursor-pointer transition-all duration-300 ease-in-out',
	variants: {
		role: {
